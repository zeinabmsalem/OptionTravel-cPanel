                        ...
                        <div class="col-xl-12">
                            ...
                            <div class="widget has-shadow">
                                <div class="widget-header bordered no-actions d-flex align-items-center">
                                  <a id="addtrans" href="add_package.php?type_id=<?php echo $type; ?>"><button type="button" class="btn btn-primary">Add Package</button></a>
                                ...
                                <div class="widget-body">
                                    <div class="table-responsive">
                                        ...
                                        <?php
                                            ...
                                            $sql = "select * from packages where package_type_id = $type";
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><img src="<?php  echo $row['card_img']; ?>" style="width: auto;
                                    height: 40px;
                                    margin-left: 10px;
                                    margin-right: 6px"></td>

                                                    <td>
                                                        <a href="view_package.php?packid=<?php echo $row['id']; ?>">
