                    ...
                    <div class="row">
                        <div class="page-header">
                            <div class="d-flex align-items-center">
                                <h2 class="page-header-title">Delete Transportation from List</h2>
                                <div>
                                    <ul class="breadcrumb">
                           ...
                           <div class="col-xs-12 col-sm-6 col-md-offset-3 col-md-6 widget-container-col" id="widget-container-col-4" style="margin-top:30px;margin-bottom:150px">
                                <div class="widget-box" id="widget-box-4">
                                    <div class="widget-header widget-header-large">
                                        <h4 class="widget-title" style="font-weight: bold;color: #fc0000;">Delete Transportation !</h4>
                                        ...
                                        <div class="widget-main">
                                            <center>
                                                <p class="alert alert-info" style="border-color: white;background-color: #0490A6">
                                                    ...
                                                    Are you sure you want to delete Transportation: <b><?php echo $row["en_brand_name"]; ?> </b> with ID: <?php echo $transid; ?>
                                    ...
                                    <div class="padding-8 clearfix" style="padding:30px">
                                        <a href="view_transportation.php?transid=<?php echo $transid; ?>">
                                            <button class="btn btn-xs btn-danger pull-left">
                                                <i class="ace-icon fa fa-times"></i>
                                                <span class="bigger-110">No, Please Cancel</span>
                                            </button>
                                        </a>
                                        <a href="delete_transportation.php?transid=<?php echo $transid ?>">  
