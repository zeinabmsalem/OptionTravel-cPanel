...
$stmt = mysqli_stmt_init($conn);
    ...
    $statmentQuery = "INSERT INTO packages (package_type_id, en_name, en_location, en_title, en_rating, en_price, video_link, card_img, en_duration, en_from_date, en_to_date, en_availability_link, en_overview, en_what_will_we_do, fr_name, fr_location, fr_title, fr_rating, fr_price, fr_duration, fr_from_date, fr_to_date, fr_availability_link, fr_overview, fr_what_will_we_do, ar_name, ar_location, ar_title, ar_rating, ar_price, ar_duration, ar_from_date, ar_to_date, ar_availability_link, ar_overview, ar_what_will_we_do)
     ...
     mysqli_stmt_bind_param($stmt, "isssssssssssssssssssssssssssssssssss", $type_id, $en_name, $en_location, $en_title, $en_rating, $en_price, $video_link, $targetFile, $en_duration, $en_from_date, $en_to_date, $en_availability_link, $en_overview, $en_what_will_we_do, $fr_name, $fr_location, $fr_title, $fr_rating, $fr_price, $fr_duration, $fr_from_date, $fr_to_date, $fr_availability_link, $fr_overview, $fr_what_will_we_do, $ar_name, $ar_location, $ar_title, $ar_rating, $ar_price, $ar_duration, $ar_from_date, $ar_to_date, $ar_availability_link, $ar_overview, $ar_what_will_we_do);
         ...
         if(mysqli_stmt_execute($stmt)){
          ...
          $last_id = mysqli_insert_id($conn);
            ...
            header("Location:view_package.php?packid=$last_id");
